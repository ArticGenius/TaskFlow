...
class MainTask : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_main_task) // Establece el diseño de la actividad

        // Obtiene las preferencias compartidas y recupera el conjunto de nombres de tareas principales
        val sharedPreferences = getSharedPreferences("MySharedPref", MODE_PRIVATE)
        val taskNames = sharedPreferences.getStringSet("mainTaskNames", mutableSetOf())

        // Configura la vista con las tareas principales
        setup(taskNames ?: mutableSetOf())
        // Configura el botón de inicio
        showhome()
    }

    // Método para configurar la vista con las tareas principales
    private fun setup(taskNames: MutableSet<String>) {
        val layout = findViewById<LinearLayout>(R.id.taskLayout)

        // Itera sobre cada tarea principal
            ...
            fabTask.setOnClickListener {
                AlertDialog.Builder(this)
                    ...
                    .setPositiveButton("Sí") { dialog, _ ->
                        ...
                        // Eliminar la tarea del conjunto de tareas principales
